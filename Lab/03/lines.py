...
class ViewGameInfo:
    def __init__(self, master):
        self.lines = Label(master, font=("Google Sans", 20), bg='#414141', fg='#ffffff')
        self.lines.grid(row=1, column=1, columnspan=3)
        self.score = Label(master, font=("Google Sans", 20), bg='#414141', fg='#ffffff')
...
class GameControls:
    def __init__(self, master):
        ...
        self.step = Button(master, text="Сделать ход", font=("Google Sans", 15), bg='#6e7078', fg='#eeeeee', padx=2,
                           pady=1, relief='flat',
                           width=15)
        self.step.grid(row=6, column=1, columnspan=3)
        self.new_game = Button(master, text="Новая игра", font=("Google Sans", 15), bg='#6e7078', fg='#eeeeee', padx=2,
                               pady=1, relief='flat',
                               width=15)
...
class GameHint(list):
    def __init__(self, master):
        ...
        Label(master, text='Подсказка:', font=("Google Sans", 15), bg='#414141', fg='#eeeeee').grid(row=7, column=1,
                                                                                                    columnspan=3)
        self.model = []
        for i in range(3):
...
class Interface:
    def __init__(self, field_size):
        ...
        self.game_over = Label(self.field_frame, text="Игра окончена", fg='white', bg='#414141',
                               font=("Google Sans", 45))
...
class Model:
    ...
    def _random_ball(self):
        ...
        balls = [
            field_tiles.ball_aqua,
            field_tiles.ball_blue,
            field_tiles.ball_green,
            field_tiles.ball_pink,
            field_tiles.ball_red,
            field_tiles.ball_violet,
    ...
    def _check_all_lines(self):
        ...
        lines += check_lines(self.field.main_dialogs)
        lines += check_lines(self.field.sub_dialogs)
